  ...
  return (
    <div id="addtext" className="addtext ">
      ...
      <div className="mt-3 mb-3 d-flex gap-2 justify-content-center align-items-center">
        <button onClick={handleBold} className="btn btn-light">
          Bold
        </button>
        <button onClick={handleItalic} className="btn btn-light">
          Italic
        </button>
